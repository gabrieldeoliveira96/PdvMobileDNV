...
uses FMX.Layouts, FMX.Objects, FMX.Types, FMX.Forms, FMX.Graphics, FMX.Ani,
     FMX.StdCtrls, SysUtils, System.Types,FMX.Skia, System.Classes;
...
type
  ...
  private
    ...
    lblTitulo, lblSubTitulo, lblItem : TSKLabel;
  ...
  published
    ...
    property ComboAtivo: Boolean read FComboAtivo write FComboAtivo;
...
begin
    ...
    lblTitulo := TSKLabel.Create(rectFundo);
    with lblTitulo do
    begin
        Text := FTitleMenuText;
        ...
        TextSettings.Font.Size := FTitleFontSize;
        TextSettings.FontColor := FTitleFontColor;
        //AutoSize := true;
        Margins.Top := 0;
        Margins.Bottom := 0;
    end;
    ...
    lblSubTitulo := TSKLabel.Create(rectFundo);
    ...
    begin
        ...
        TextSettings.VertAlign := TTextAlign.Center;
        TextSettings.HorzAlign := TSkTextHorzAlign.Center;
        TextSettings.Font.Size := FSubTitleFontSize;
        TextSettings.FontColor := FSubTitleFontColor;
        //AutoSize := true;
        Margins.Top := 0;
        Margins.Bottom := 0;
    end;
...
begin
    FCodItem := TSKLabel(Sender).TagString;
    FDescrItem := TSKLabel(Sender).Text;
    ACallBack(Sender);
end;
{$ELSE}
...
begin
    ...
    lblTitulo.TextSettings.Font.Size := FTitleFontSize;
    ...
    lblSubTitulo.TextSettings.Font.Size := FSubTitleFontSize;
...
begin
    ...
    lblItem := TSKLabel.Create(rectItem);
    with lblItem do
    begin
        Text := itemText;
        Align := TAlignLayout.Client;
        ...
        TextSettings.Font.Size := FItemFontSize;
        TextSettings.FontColor := FItemFontColor;
        HitTest := true;
        Margins.Left := 10;
        Margins.Right := 10;
        TagString := codItem;
...
procedure TCustomCombo.CloseFinish(Sender: TObject);
begin
  if ani.Inverse then
    FOnClose(self);
end;
